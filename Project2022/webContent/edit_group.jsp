				...
				<div class="row">
					...
					<div class="col-lg-12">
						<div class="p-5">
							...
							<form class="user" action="GroupController?action=edit1"
								method="post">
								<div class="form-group row">
									<input type="hidden" class="form-control form-control-user"
										id="exampleLastName" placeholder="Nombre des etudiant"
										name="id" value="${groupe.id }" required>
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input type="text" class="form-control form-control-user"
											id="exampleFirstName" placeholder="label"
											value="${groupe.label }" name="label" required>
									</div>
									<div class="col-sm-6">
										<input type="text" class="form-control form-control-user"
											id="exampleLastName" placeholder="Nombre des etudiant"
											name="nb_etd" value="${groupe.nb_etd }" required>
									</div>
								</div>
